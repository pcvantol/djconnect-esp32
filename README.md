...
For example, `./release.sh 2.9.13 --dry-run` validates the release plan without touching files. Both `2.9.13` and `v2.9.13` are accepted; the script normalizes tags to `vX.Y.Z`.
