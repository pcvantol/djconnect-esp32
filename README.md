...
For example, `./release.sh 2.8.1 --dry-run` validates the release plan without touching files. Both `2.8.1` and `v2.8.1` are accepted; the script normalizes tags to `vX.Y.Z`.
