...
For example, `./release.sh 2.9.14 --dry-run` validates the release plan without touching files. Both `2.9.14` and `v2.9.14` are accepted; the script normalizes tags to `vX.Y.Z`.
