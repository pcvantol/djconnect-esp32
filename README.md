...
For example, `./release.sh 2.9.7 --dry-run` validates the release plan without touching files. Both `2.9.7` and `v2.9.7` are accepted; the script normalizes tags to `vX.Y.Z`.
