...
constexpr Entry Entries[] = {
    ...
    {"confirm_yes_change_wifi", "Yes, open setup portal", "Ja, setup portal openen"},
    ...
    {"voice_dj_response", "DJ response", "DJ response"},
    {"voice_no_dj_response", "No DJ response", "Geen DJ response"},
    ...
    {"up_next", "Up next", "Volgende nummers"},
    {"volume", "Vol", "Vol"},
    {"web", "Web", "Web"},
    {"wifi", "WiFi", "WiFi"},
