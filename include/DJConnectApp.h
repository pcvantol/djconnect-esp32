...
private:
  ...
  uint32_t pongPaddleFlashUntil_ = 0;
  uint32_t pongWallFlashUntil_ = 0;
  uint32_t pongRestartAt_ = 0;
  ...
  int asteroidSize_ = 7;
  int asteroidShape_ = 0;
  int asteroidExplodeX_ = 160;
  int asteroidExplodeY_ = 48;
  ...
  uint32_t asteroidExplodeUntil_ = 0;
  int flyerPlaneY_ = 86;
  int flyerObstacleX_ = 300;
  int flyerObstacleY_ = 86;
  int flyerObstacleShape_ = 0;
  int flyerObstacleColor_ = 0;
  int flyerExplodeX_ = 300;
  int flyerExplodeY_ = 86;
  int flyerShotX_ = 0;
  int flyerScore_ = 0;
  int flyerHighScore_ = 0;
  bool flyerShotActive_ = false;
  uint32_t flyerFlashUntil_ = 0;
  uint32_t flyerExplodeUntil_ = 0;
  uint32_t flyerRestartAt_ = 0;
  int mazePlayerX_ = 52;
  int mazePlayerLane_ = 1;
  int mazePlayerDirX_ = 1;
  int mazePlayerDirY_ = 0;
  int mazeGhostX_ = 278;
  ...
  uint8_t mazePowerPellets_ = 0x0F;
  uint32_t mazePowerUntil_ = 0;
  uint32_t mazeFlashUntil_ = 0;
  uint32_t mazeDeathUntil_ = 0;
  uint32_t mazeRestartAt_ = 0;
  ...
  bool idleSleepSuppressedLogged_ = false;
